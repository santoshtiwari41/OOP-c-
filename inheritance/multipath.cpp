...

{
...

    {
        ...
        cout<<"name:"<<name<<endl<<"address:"<<address<<endl<<"No of programs:"<<No_of_Programs<<endl;
...

{
...

    {
        ...
        cout<<"school name:"<<schoolName<<endl<<"dean name:"<<dean<<endl<<"Program:"<<NO_OF_PROGRAMS<<endl;
...

{
...

    {
        ...
        cout<<"name of student:"<<name<<endl<<"Program:"<<program<<endl<<"Enrolled Year:"<<enrolledYear<<endl;
...

{
    ...
    student s("pokhara","kaski","NCIT","Balkumari",3,"laliguras","Alien","computer","ABC","BECE",2022);
